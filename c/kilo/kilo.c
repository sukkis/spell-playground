...
// followed tutorial at https://viewsourcecode.org/snaptoken/kilo
// the tutorial is based on blog post by antirez https://antirez.com/news/108

/* ---------- FEATURE-TEST MACROS (must be first) ---------- */
#define _DEFAULT_SOURCE /* or _DEFAULT_SOURCE on newer glibc */
#define _GNU_SOURCE     /* enables strdup, asprintf, etc. */
...
struct editorSyntax HLDB[] = {{
    "c",              // filetype
    C_HL_extensions,  // extensions (".c", ".h", ".cpp")
    C_HL_keywords,    // keyword list
    "//", "/*", "*/",
...
void die(const char *s) {
    // refresh screen and put cursor up
